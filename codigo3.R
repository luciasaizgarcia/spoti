...
library(plumber)
#*@apiName Consulta Spotify
#*@apiTitle Consulta Spotify
#*@apiDescription Esta API devuelve la cancion mas 
#*reciente del artista mas popular relacionado
#*con el artista que yo informo

#* @param ARTIST Indica nombre del artista
#* @get /ARTIST
...
function(ARTIST=""){
  ...
  print(paste("La cancion", TRACK, "del cantante", ARTIST_2, "tiene una popularidad de", POPULARIDAD,". Este artista se hizo muy famoso por colaborar con", ARTIST_1))
}
